...
async function resolveDependencies(dependencies, resolved = {}, parent = null, peerWarnings = [], optionalWarnings = []) {
  ...
  async function worker([name, versionRange]) {
    ...
    await resolveDependencies(pkg.dependencies || {}, resolved, name, peerWarnings, optionalWarnings);
  }
