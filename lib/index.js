...
async function main(args) {
    ...
    try {
        ...
        // Improved error output with boxen
        const errorMsg = chalk.red.bold('❌ Install failed!') +
            '\n' + chalk.gray(err && err.message ? err.message : err) +
            '\n\n' + chalk.yellow('Tip: This is often a network issue. Try running the install again, or check your internet connection.');
        console.log(boxen(errorMsg, {
            padding: 1,
            margin: 1,
            borderStyle: 'round',
            borderColor: 'red',
